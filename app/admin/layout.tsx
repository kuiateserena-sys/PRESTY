              ...
              return (
                ...
                >
                  ...
                  {item.href === "/admin/notifications" && (
                    <span className="ml-auto flex h-5 min-w-5 items-center justify-center rounded-full bg-[#563065] px-1.5 text-[9px] text-white">
                      3
                    </span>
                  )}
                </Link>
        ...
        <header className="sticky top-0 z-40 flex h-[76px] items-center justify-between border-b border-black/[0.06] bg-white/80 px-6 backdrop-blur-xl dark:border-white/10 dark:bg-[#151117]/80 md:px-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              className="relative flex h-10 w-10 items-center justify-center rounded-full border border-black/[0.07] bg-white transition hover:border-[#563065]/30 hover:text-[#563065] dark:border-white/10 dark:bg-white/[0.04]"
            >
              ...
              <span className="absolute right-2 top-2 h-2 w-2 rounded-full bg-[#563065]" />
            ...
            <div className="flex items-center gap-3 rounded-full border border-black/[0.07] bg-white px-3 py-2 dark:border-white/10 dark:bg-white/[0.04]">
              ...
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#563065] text-xs font-medium text-white">
                A
              </div>
